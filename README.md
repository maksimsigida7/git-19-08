...
**_Если вы хотите начать работать с Git, прочитав всего одну главу, то эта глава — то, что вам нужно. Здесь рассмотрены все базовые команды, необходимые вам для решения подавляющего большинства задач, возникающих при работе с Git._** (Это очень легко) (Поправка номер один)(Поправка номер два) (Поправка номер три)
...
# Новое дополнение через гитхаб

# Новое сообщение отправленное на удаленный  репозиторий.